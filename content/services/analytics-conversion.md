...
Analytics should clarify which pages, campaigns, and workflows are producing results. Burn.Blue helps teams set up measurement that supports better decisions without drowning them in dashboards.

### What this includes
- Analytics and event tracking plans
- Conversion path review
- Landing page recommendations
- Funnel and form analysis
- Practical reporting for owners and teams
