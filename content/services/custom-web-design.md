...
Burn.Blue designs websites that look polished without burying the message. The work starts with positioning, audience intent, and the actions visitors need to take.

### What this includes
- Homepage and landing page design
- Service page layouts
- Brand direction, color, typography, and UI components
- Responsive design for mobile, tablet, and desktop
- Accessible patterns that keep the experience usable
