...
A professional site should feel instant, stable, and easy to maintain. Burn.Blue builds responsive websites with semantic HTML, focused CSS, and deployment-friendly structure.

### What this includes
- Hugo static site builds
- Custom layouts and reusable content templates
- Mobile-first responsive implementation
- Accessibility and performance checks
- Git-based workflows for safe iteration
